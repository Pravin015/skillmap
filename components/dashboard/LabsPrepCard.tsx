  ...
  return (
    <div className="rounded-2xl border overflow-hidden relative" style={{ borderColor: "var(--border)", background: "var(--ink)" }}>
      ...
      <div className="p-6 relative">
        ...
        <button className={`mt-5 w-full py-3 rounded-xl ${heading} font-bold text-sm border transition-colors hover:border-[var(--primary)]`} style={{ borderColor: "rgba(255,255,255,0.15)", color: "var(--primary)", background: "transparent" }}>
