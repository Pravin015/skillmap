        ...
        {step === 1 && (
          <>
            ...
            <form onSubmit={handleStep1} className="rounded-2xl border bg-white p-6" style={{ borderColor: "var(--border)" }}>
              ...
              {/* OTP Section */}
              {otpSent && !otpVerified && (
                <div className="mt-4 rounded-xl p-4 border" style={{ background: "rgba(124,58,237,0.05)", borderColor: "rgba(124,58,237,0.2)" }}>
            ...
            {activeRole === "STUDENT" && (
              <div className="mt-5">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="text-[10px] uppercase tracking-wider" style={{ color: "var(--muted)" }}>or sign up faster with</span>
                  <div className="flex-1 h-px" style={{ background: "var(--border)" }} />
                </div>
                <SocialSignIn callbackUrl="/onboarding" />
              </div>
            )}
          </>
        )}
