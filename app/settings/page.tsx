    ...
    <div className="min-h-[calc(100vh-4rem)] py-8 px-4 md:px-8" style={{ background: "var(--surface)" }}>
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="rounded-2xl border bg-white p-6" style={{ borderColor: "var(--border)" }}>
          ...
          <div className="flex items-center gap-4">
            {profileImage ? (
              ...
              <div className={`w-20 h-20 rounded-2xl flex items-center justify-center ${syne} font-extrabold text-2xl text-white`} style={{ background: "var(--ink)" }}>
        ...
        <form onSubmit={handleSaveProfile} className="rounded-2xl border bg-white p-6" style={{ borderColor: "var(--border)" }}>
          <h2 className={`${syne} font-bold text-base mb-4`}>Personal Information</h2>
        ...
        <form onSubmit={handleChangePassword} className="rounded-2xl border bg-white p-6" style={{ borderColor: "var(--border)" }}>
          <h2 className={`${syne} font-bold text-base mb-4`}>Change Password</h2>
          ...
          <div className="space-y-4">
            <div><label className={`block text-sm font-medium mb-1.5 ${syne}`}>Current Password</label>
            ...
            <div><label className={`block text-sm font-medium mb-1.5 ${syne}`}>New Password</label>
