    ...
    <div className="mx-auto flex min-h-[calc(100vh-4rem)] max-w-2xl flex-col px-4 py-12">
      ...
      <div className="mt-8 flex items-center justify-between">
        ...
        <button
          onClick={handleNext}
          disabled={!canProceed()}
          className="rounded-xl bg-indigo-600 px-6 py-3 text-sm font-semibold text-white transition-all hover:bg-indigo-700 disabled:cursor-not-allowed disabled:opacity-40"
        >
