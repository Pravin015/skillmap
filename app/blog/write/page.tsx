...
export default function WriteBlogPage() {
  ...
  if (!["ADMIN", "MENTOR", "HR"].includes(userRole || "")) {
    return <div className="flex min-h-[60vh] items-center justify-center"><div className="text-center"><div className="text-5xl mb-4">🔒</div><p className={`${syne} font-bold text-xl`}>Access Denied</p><p className="text-sm" style={{ color: "var(--muted)" }}>Only Admin, Mentors, and HR can write blog posts</p></div></div>;
  }
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] py-8 px-4 md:px-8" style={{ background: "var(--surface)" }}>
      <div className="max-w-3xl mx-auto">
        <div className="mb-8">
          <h1 className={`${syne} font-extrabold text-2xl`}>Write a Blog Post</h1>
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-2xl border bg-white p-6 space-y-4" style={{ borderColor: "var(--border)" }}>
            <div><label className={`block text-sm font-medium mb-1.5 ${syne}`}>Title *</label>
            ...
            <div><label className={`block text-sm font-medium mb-1.5 ${syne}`}>Excerpt</label>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div><label className={`block text-sm font-medium mb-1.5 ${syne}`}>Tags</label>
              ...
              <div><label className={`block text-sm font-medium mb-1.5 ${syne}`}>Category</label>
            ...
            <div><label className={`block text-sm font-medium mb-1.5 ${syne}`}>Video URL (YouTube/Vimeo)</label>
          ...
          {/* Content */}
          <div className="rounded-2xl border bg-white p-6" style={{ borderColor: "var(--border)" }}>
            <label className={`block text-sm font-medium mb-1.5 ${syne}`}>Content * <span className="font-normal" style={{ color: "var(--muted)" }}>(HTML supported)</span></label>
