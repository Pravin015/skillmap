  ...
  return (
    <LegalPage title="Shipping & Delivery Policy" lastUpdated="12 April 2026">
      ...
      <ul>
        ...
        <li><strong>Institution Plan:</strong> Access is provisioned within 2-3 business days after agreement signing.</li>
      </ul>

      <h2>2. What You Receive</h2>
      <h3>2.1 Free Plan (Explorer)</h3>
      <ul>
        <li>Access to company skill maps</li>
        <li>Live job opening browsing</li>
        <li>Basic AI chat (limited messages)</li>
        <li>Interview process overview</li>
      </ul>

      <h3>2.2 Career Ready Plan</h3>
      <ul>
        <li>Everything in Free Plan</li>
        <li>Unlimited AI mentor conversations</li>
        <li>Full skill gap analysis</li>
        <li>Personalised week-by-week prep roadmap</li>
        <li>Job alerts for matched positions</li>
      ...
      <ul>
        <li><strong>Account features:</strong> Instantly available after signup or payment.</li>
        <li><strong>AI-generated roadmaps:</strong> Generated in real-time during chat interactions.</li>
        <li><strong>Job matching:</strong> Updated continuously as new jobs are posted.</li>
        <li><strong>Mentor sessions:</strong> Delivered at the scheduled time as booked.</li>
      </ul>
