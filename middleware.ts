...
export const config = {
  matcher: ["/dashboard/:path*", "/chat/:path*", "/admin/:path*", "/onboarding/:path*", "/hr-dashboard/:path*", "/company-dashboard/:path*", "/institution-dashboard/:path*", "/mentor-dashboard/:path*", "/profile/:path*", "/settings/:path*", "/notifications/:path*", "/mock-interview/history/:path*"],
};
