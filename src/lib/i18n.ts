...
const en = {
  ...
  "home.hero.pre": "One marketplace.", "home.hero.em": "Hundreds of verified trainers", "home.hero.post": "to deliver any batch.",
...
const hi: Partial<Record<TKey, string>> = {
  ...
  "home.hero.pre": "एक मार्केटप्लेस।", "home.hero.em": "सैकड़ों सत्यापित ट्रेनर", "home.hero.post": "किसी भी बैच को पूरा करने के लिए।",
